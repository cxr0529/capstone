...
const initSpeciality = [
    'Dentist', 'Gynecologist/obstetrician', 'General Physician', 'Dermatologist', 'Ear-nose-throat (ent) Specialist', 'Homeopath'
]
...
const FindDoctorSearch = () => {
    ...
    const handleDoctorSelect = (speciality) => {
        ...
        navigate(`/Booking?speciality=${speciality}`);
            ...
            <center>
                ...
                <div>               <i style={{color:'#000000',fontSize:'20rem'}} className="fa fa-user-md"></i>
                    ...
                    {/* <p>Perform a search to see the results.</p> */}
                        ...
                        <div className="findiconimg"><img className='findIcon' src={process.env.PUBLIC_URL + '/images/search.jpg'} alt=""/></div>
                        <div className="search-doctor-input-results" hidden={doctorResultHidden}>
                            {
                                specialities.map(speciality => <div className="search-doctor-result-item" key={speciality} onMouseDown={() => handleDoctorSelect(speciality)}>
                                    <span><img src={process.env.PUBLIC_URL + '/images/search.jpg'} alt="" style={{height:"10px", width:"10px"}} width="12" /></span>
